...
class TestSdeRuntimeEngine(unittest.TestCase):
    ...
    def setUp(self, MockSchedulerFactory, MockComputeScheduler):
        ...
        self.mock_adaptive_scheduler = (
            MockSchedulerFactory.create_scheduler.return_value
        )
    ...
    def test_work_unit_error_sets_trial_to_failed(self):
        ...
        """
        work_unit = WorkUnit(
            trial_id="trial1", type=WorkUnitType.TRAIN_EPOCH, payload={}
        )
        ...
        self.mock_event_callback.assert_called_with(
            EngineEvent.TRIAL_UPDATED, {"trial": updated_trial.to_dict()}
        )
