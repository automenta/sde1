...
class TestWorker(unittest.TestCase):
    ...
    def test_batch_size_hyperparameter_is_used(
        self, mock_create_dataloaders, mock_torch_save
    ):
        ...
        mock_dataset_def.loader_factory.return_value = (
            mock_train_loader,
            mock_val_loader,
        )
        ...
        mock_dataset_def.loss_function_factory.return_value = (
        ...
        mock_dataset_def.loader_factory.assert_called_with(
            batch_size=64
        )  # 64 is the default
