...
from ...models.types import SdeModel
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.layer1 = self._make_layer(
            ResidualBlock, num_init_features, block_config[0], stride=1
        )
        self.layer2 = self._make_layer(
            ResidualBlock, num_init_features * 2, block_config[1], stride=2
        )
        self.layer3 = self._make_layer(
            ResidualBlock, num_init_features * 4, block_config[2], stride=2
        )
        self.layer4 = self._make_layer(
            ResidualBlock, num_init_features * 8, block_config[3], stride=2
        )
...
CONFIGURABLE_RESNET_MODEL = ModelDefinition(
    ...
    hyperparameter_schema={
        "model_params": {
            ...
            "num_init_features": {"type": "int", "default": 64, "options": [32, 64]},
        },
        "optimizer_params": {
